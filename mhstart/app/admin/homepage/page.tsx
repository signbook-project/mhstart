...
export default function AdminHomepagePage() {
  ...
  const [tab, setTab] = useState<"hero" | "banners" | "spotlight" | "site">(
    "hero",
  );
  ...
  useEffect(() => {
    ...
    fetch("/api/admin/listings?status=active")
      .then((r) => r.json())
      .then((d) => setListings(d.data || []));
    fetch("/api/admin/spotlight")
      .then((r) => r.json())
      .then((d) => setSpotlight(d.data || null));
  }, []);
  ...
  useEffect(() => {
    if (settings?.homepage) setHero(structuredClone(settings.homepage));
    if (settings?.site) setSite(structuredClone(settings.site));
  }, [settings]);
  const tabs = [
  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        ...
        >
          Edit all homepage content from here
        </p>
      </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setHero((h: any) => ({ ...h, hero_title: e.target.value }))
                }
                placeholder="Maharashtra's Startup Ecosystem"
              />
            </div>
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setHero((h: any) => ({ ...h, hero_subtitle: e.target.value }))
                }
                style={{ minHeight: 90 }}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                value={hero.hero_cta || ""}
                onChange={(e) =>
                  setHero((h: any) => ({ ...h, hero_cta: e.target.value }))
                }
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setHero((h: any) => ({ ...h, hero_image: e.target.value }))
                }
                placeholder="https://..."
              />
            </div>
            <button
              ...
              onClick={() => saveSetting("homepage", hero)}
          ...
          >
            <div className="form-group">
              ...
              <input
                ...
                value={site.name || ""}
                onChange={(e) =>
                  setSite((s: any) => ({ ...s, name: e.target.value }))
                }
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                value={site.tagline || ""}
                onChange={(e) =>
                  setSite((s: any) => ({ ...s, tagline: e.target.value }))
                }
              />
            </div>
            <div className="form-group" style={{ gridColumn: "1 / -1" }}>
              <label className="form-label">
                About Text (used in About page & Footer)
              </label>
              <textarea
                className="form-textarea"
                value={site.about || ""}
                onChange={(e) =>
                  setSite((s: any) => ({ ...s, about: e.target.value }))
                }
                style={{ minHeight: 120 }}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setSite((s: any) => ({ ...s, contact_email: e.target.value }))
                }
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setSite((s: any) => ({ ...s, contact_phone: e.target.value }))
                }
              />
            </div>
            <div className="form-group" style={{ gridColumn: "1 / -1" }}>
              ...
              <input
                ...
                value={site.address || ""}
                onChange={(e) =>
                  setSite((s: any) => ({ ...s, address: e.target.value }))
                }
              />
            </div>
          </div>
        ...
        <div>
          ...
          >
            <p style={{ color: "var(--text-secondary)", fontSize: 14 }}>
              Banners shown on homepage (ordered by display order)
            </p>
            <button
              className="btn btn-primary"
              onClick={() => {
...
function SpotlightEditor({ listings, spotlight, onSave }: any) {
  ...
  const save = async () => {
    ...
    const res = await fetch("/api/admin/spotlight", {
      method: spotlight ? "PATCH" : "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ ...form, id: spotlight?.id }),
    });
    if (res.ok) {
  ...
  return (
    ...
    >
      ...
      >
        Choose a startup to highlight on the homepage as "Startup of the Week"
      </p>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        <div className="form-group" style={{ gridColumn: "1 / -1" }}>
          ...
          <select
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, listing_id: e.target.value }))
            }
          >
        ...
        <div className="form-group" style={{ gridColumn: "1 / -1" }}>
          <label className="form-label">
            Custom Title (overrides listing name)
          </label>
          <input
            className="form-input"
            ...
            placeholder="Leave blank to use listing name"
          />
        </div>
        <div className="form-group" style={{ gridColumn: "1 / -1" }}>
          <label className="form-label">
            Custom Description (overrides tagline)
          </label>
          <textarea
            className="form-textarea"
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, custom_image: e.target.value }))
            }
          />
        </div>
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, week_start: e.target.value }))
            }
          />
        </div>
        <div
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <input
              ...
              style={{ width: 16, height: 16 }}
            />
            <label htmlFor="b_active" style={{ fontSize: 14, fontWeight: 600 }}>
              Active
            </label>
          </div>
        </div>
