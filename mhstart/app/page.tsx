...
async function getHomepageData() {
  const [settingsRes, newsRes, listingsRes, spotlightRes, bannersRes] =
    await Promise.all([
      ...
      supabase
        .from("map_listings")
        .select("id,name,type,tagline,logo_url,city,sector")
        .eq("status", "active")
        .limit(40),
      supabase
        .from("spotlight")
...
export default async function HomePage() {
  const { settings, news, listings, spotlight, banners } =
            ...
            <div>
              ...
              >
                {homepage.hero_subtitle ||
                  "Connecting founders, investors, incubators, and enablers across the state. Discover. Connect. Grow."}
              </p>
              ...
              >
                {[
                  {
                    num:
                      listings.filter((l) => l.type === "startup").length ||
                      "100+",
                    label: "Startups",
                  },
                  {
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(135deg, rgba(255,107,53,0.3), rgba(212,160,23,0.2))",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: 64,
          ...
          <div className="ticker-track">
            {[...listings, ...listings].map((l, i) => (
              <div key={i} className="ticker-item">
                ...
                <span
                  className={`badge badge-${l.type === "startup" ? "saffron" : "navy"}`}
                  style={{ fontSize: 11 }}
                >
              ...
              <div>
                ...
                >
                  {spotlight.listing?.logo_url && (
                    <img
                      src={spotlight.listing.logo_url}
                      alt="logo"
                      style={{
                        height: 48,
                        objectFit: "contain",
                  ...
                  {spotlight.listing && (
                    <Link
                      href={`/map?id=${spotlight.listing.id}`}
                      className="btn btn-primary"
                    >
                      View Profile →
                    </Link>
        ...
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p
              ...
              style={{ margin: "12px auto 32px" }}
            >
              Explore the growing network of startups, incubators, VCs and
              enablers on our interactive map.
            </p>
          ...
          >
            {[
              ...
              const count = listings.filter(
                (l) =>
                  l.type === t.type ||
                  (t.type === "vc" && (l.type === "vc" || l.type === "angel")),
              ).length;
              return (
                <div
                  key={t.type}
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none'%3E%3Ccircle cx='30' cy='30' r='2' fill='%23FF6B35' fill-opacity='0.08'/%3E%3C/g%3E%3C/svg%3E\")",
          }}
        />
        <div
          className="container"
        ...
        >
          ...
          >
            List your startup or organization on MHStart and get discovered by
